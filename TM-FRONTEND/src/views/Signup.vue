									...
									<div class="center-wrap">
										<div class="section text-center">
											...
											<div class="form-group">
												<input type="text" name="logname" class="form-style" placeholder="Your Username" id="logname" autocomplete="off">
								...
								<div class="card-back">
									<div class="center-wrap">
										<div class="section text-center">
                                            ...
                                            <div class="form-group">
												<input type="text" name="logname" class="form-style" placeholder="Your Number" id="logname" autocomplete="off">
...
.checkbox:checked + label:before {
	transform: translateX(44px) rotate(-322deg);
}
